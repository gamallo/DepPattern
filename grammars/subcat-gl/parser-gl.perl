...
# Agreement: gender, number
(@temp) = ($listTags =~ /($NOUN$a)($ADJ$a|$CONJ${l}coord:adj\|${r})/g);
$Rel =  "AdjnR";
HeadDep($Rel,"gender,number",@temp);
$listTags =~ s/($NOUN${l}concord:1${r})($ADJ${l}concord:1${r}|$CONJ${l}concord:1${b}coord:adj\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
...
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VS\|${r})($NOUNCOORD|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
...
# Agr: number, person
# Add: adsubj:yes
(@temp) = ($listTags =~ /($VERB${l}lemma:$VSrefleja\|${b}se:yes\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VSrefleja\|${b}se:yes\|${r})($NOUNCOORD|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
Add("HeadDep","adsubj:yes",@temp);
...
# Agr: number, person
# Add: adsubj:yes
(@temp) = ($listTags =~ /($VERB${l}ind:yes\|${b}lemma:$VSind\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}ind:yes\|${b}lemma:$VSind\|${r})($NOUNCOORD|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
Add("HeadDep","adsubj:yes",@temp);
...
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VS\|${r})($VERB${l}concord:1${b}mode:N\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
Add("HeadDep","adsubj:yes",@temp);
...
# Agr: number, person
# Add: adsubj:yes
(@temp) = ($listTags =~ /($VERB${l}lemma:$VSrefleja\|${b}se:yes\|${r})($VERB${l}mode:N\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VSrefleja\|${b}se:yes\|${r})($VERB${l}concord:1${b}mode:N\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
Add("HeadDep","adsubj:yes",@temp);
...
# Agr: number, person
# Add: adsubj:yes
(@temp) = ($listTags =~ /($VERB${l}ind:yes\|${b}lemma:$VSind\|${r})($VERB${l}mode:N\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}ind:yes\|${b}lemma:$VSind\|${r})($VERB${l}concord:1${b}mode:N\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
Add("HeadDep","adsubj:yes",@temp);
...
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VS\|${r})($NOMINAL|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;

# SubjR: VERB<se:yes&lemma:$VSrefleja> NOMINAL|PRO<type:D|P|I|X>
# Agr: number, person
(@temp) = ($listTags =~ /($VERB${l}lemma:$VSrefleja\|${b}se:yes\|${r})($NOMINAL|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}lemma:$VSrefleja\|${b}se:yes\|${r})($NOMINAL|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;

# SubjR: VERB<ind:yes&lemma:$VSind> NOMINAL|PRO<type:D|P|I|X>
# Agr: number, person
(@temp) = ($listTags =~ /($VERB${l}ind:yes\|${b}lemma:$VSind\|${r})($NOMINAL|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "SubjR";
HeadDep($Rel,"number,person",@temp);
$listTags =~ s/($VERB${l}concord:1${b}ind:yes\|${b}lemma:$VSind\|${r})($NOMINAL|$PRO${l}concord:1${b}type:(?:D|P|I|X)\|${r})/$1/g;
$listTags =~ s/concord:[01]\|//g;
